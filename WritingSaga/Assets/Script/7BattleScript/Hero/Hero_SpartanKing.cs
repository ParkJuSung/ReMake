...
public class Hero_SpartanKing : Unit {
    ...
    void Start()
    {
		...
		if(Hero.summonIsSpartanKing[0])
		{
			skillSlot = GameObject.Find("SkillSlot1");
			skillSlot2 = GameObject.Find("SkillSlot2");
		}
		else if(Hero.summonIsSpartanKing[1])
		{
			skillSlot = GameObject.Find("SkillSlot9");
			skillSlot2 = GameObject.Find("SkillSlot10");
		}
    ...
    void Update()
    {
		...
		DrawHeroBar(HPBar, HeadUpPosition, HP, 2000, stateScreen, Current_State.ToString(), 
			"Tame:"+skillSlot.GetComponent<Skill>().Current_State.ToString(), 
			"Brave:"+skillSlot2.GetComponent<Skill>().Current_State.ToString());
